...
public class CreateActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //if permission to read from SD is not given, request permission
        ...
        add_btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                try {
                    ...
                    Toast.makeText(getApplicationContext(), "Could not add recipe, titles must be unique", Toast.LENGTH_SHORT).show();
                }
    ...
    private void addRecipeToDatabse() throws SQLException{
        ...
        //do error checking
        if(imgPath==null||imgPath.equals("")){//set default image
            imgPath="";
        }
        //add to database
