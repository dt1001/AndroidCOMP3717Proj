...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Recipe recipe = dbhelper.getRecipe(1);
        final String[]recipeName = new String[1];
        recipeName[0]=recipe.getTitle();
        final String [] recipeImage = new String[1];
        ...
        adapter.setListener(new CaptionedImagesAdapter.Listener() {
                public void onClick(int position) {
                    ...
                    intent.putExtra(RecipeFragmentDetail.EXTRA_RecipeTitle, recipeName[position]);
